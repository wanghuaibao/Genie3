      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
        <div className="text-center">
          ...
          <p className="text-xl lg:text-2xl text-blue-100 mb-12 max-w-4xl mx-auto leading-relaxed">
            Experience <strong>Genie3</strong> - Revolutionary AI technology at <strong>Genie3.top</strong>. 
          ...
          <div className="mt-12 text-center">
            <p className="text-blue-200 mb-6">Powered by <strong>Genie3</strong> - Cutting-edge AI research at <strong>Genie3.top</strong></p>
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
              {/* Placeholder for company logos */}
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-6 py-3 text-white font-semibold">Advanced AI</div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-6 py-3 text-white font-semibold">Foundation Model</div>
